...
;;; CSE341 - code for Racket lecture on delayed evaluation.
...
;;; parameters are evaluated at most once.  Racket of course uses
;;; call-by-value.  However, we can simulate call-by-name by wrapping
;;; each parameter in a lambda (also known traditionally as a
;;; 'thunk').
